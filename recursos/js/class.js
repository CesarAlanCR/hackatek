...
document.addEventListener('DOMContentLoaded', function(){
	...
	if (mapContainer && typeof L !== 'undefined') {
		...
		if (typeof L === 'undefined') {
			console.error('❌ Leaflet no está disponible - verificar carga de script');
		}
		// Si Leaflet no está disponible, al menos intenta poblar el panel de clima con el centro por defecto
		console.log('🔄 Intentando cargar clima sin mapa...');
		if (OWM_API_KEY) {
	...
	console.log('🔘 Botón detalle encontrado:', !!btnDetalle);
	
	if (btnDetalle) {
		btnDetalle.addEventListener('click', async () => {
			console.log('🔘 Botón Ver detalle clickeado');
